...
console.log(`A primeira cidade : ${cidadePrimeira} --> A segunda cidade: ${cidadeSegunda}`);
console.log(`Os nomes são iguais: ${comparativo}`)

console.log('\n')
console.log(`A primeira cidade minuscula: ${cidadePrimeiraMinuscula} --> A segunda cidade: ${cidadeSegunda}`);
